-- Create tables for Talent3X - University of East London Deployment
-- This script creates all necessary tables and initial data for UEL deployment
...
INSERT INTO skills (label, description) VALUES
  ('Web Development', 'Creating websites and web applications using HTML, CSS, JavaScript and frameworks'),
  ('Mobile App Development', 'Building mobile applications for iOS and Android platforms'),
  ('Data Analysis', 'Analyzing and interpreting complex data sets to derive insights'),
  ...
  ('Database Management', 'Designing, implementing, and maintaining database systems'),
  ('UI/UX Design', 'Creating user interfaces and experiences for digital products'),
  ...
  ('Blockchain Development', 'Building decentralized applications and smart contracts'),
  ...
  ('Software Testing', 'Evaluating and verifying software applications for quality assurance')
ON CONFLICT (label) DO NOTHING;

-- Insert sample admin code for University of East London deployment
-- Note: This is a sample code that should be replaced with a secure code in production
INSERT INTO admin_codes (code, purpose, valid_from, valid_to) VALUES
  ('UEL-ADMIN-2025', 'University of East London Admin Access', NOW(), NOW() + INTERVAL '1 year')
