-- Correct RLS policies for task_assignments table
-- Ensure both assignees and task creators can view assignments using proper UUID relationships
...
-- Assignees can view their own assignments (using UUID)
